  ...
  function Hero(go) {
    return h('section', { class: 'landing' },
      h('div', {},
        ...
        h('button', { class: 'btn btn-primary btn-big', onclick: () => go('/register') }, 'Sign up'),
        h('button', { class: 'btn btn-ghost btn-big', onclick: () => go('/login') }, 'Login'),
        h('button', {
    class: 'btn btn-kid-cta btn-big',
    onclick: () => go('/kid-login'),
  },
    h('span', { class: 'kid-cta-emoji' }, '🦊'),
    h('span', {}, "I'm a kid"),
  ),
),
      ),
